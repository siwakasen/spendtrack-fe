            ...
            <div className="max-w-[512px] w-full h-full bg-black transform transition-all p-14 rounded-lg z-10 flex flex-col justify-center items-center" >
                ...
                <form onSubmit={handleSubmit} className="max-w-full w-full">
                    ...
                    <div className="mb-6">
                        ...
                        <input type="date" name="date_of_expense" id="date_of_expense" value={dateOfExpense} onChange={(e) => handleInput(e)} max={dayjs().format('YYYY-MM-DD')} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                    <div className="mb-6">
